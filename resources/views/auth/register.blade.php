                        ...
                        <div class="card-body">
                            <form method="POST" action="{{ route('register') }}">
                                ...
                                <div class="form-label-group">
                                    <input type=text" id="inputUserame" class="form-control" placeholder="Username" required id="Username" type="text" class="form-control @error('name') is-invalid @enderror" name="first_name" value="{{ old('name') }}" required autocomplete="name">
                                ...
                                <div class="form-label-group">
                                    <input type=text" id="inputUserame" class="form-control" placeholder="Username" required id="Username" type="text" class="form-control @error('name') is-invalid @enderror" name="last_name" value="{{ old('name') }}" required autocomplete="name">
                                    <label for="Username" class="col-md-4 col-form-label text-md-left">Naam</label>
