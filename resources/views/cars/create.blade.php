                    ...
                    <div class="card-body">
                        <form method="POST" enctype="multipart/form-data" action={{route('cars.store')}}>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="merk" type="text" class="form-control @error('name') is-invalid @enderror" name="merk"  required autocomplete="merk" autofocus>
                                </div>
                                <label for="type" class="col-md-4 col-form-label text-md-right">{{ __('Model') }}</label>
                                <div class="col-md-6">
                                    <input id="type" type="text" class="form-control @error('type') is-invalid @enderror" name="type"  required autocomplete="type" autofocus>
                                </div>
                                <label for="license_plate" class="col-md-4 col-form-label text-md-right">{{ __('Kenteken') }}</label>
                                <div class="col-md-6">
                                    <input id="license_plate" type="text" class="form-control @error('type') is-invalid @enderror" name="license_plate"  required autocomplete="license_plate" autofocus>
                                </div>
                                <label for="price" class="col-md-4 col-form-label text-md-right">{{ __('Prijs per dag') }}</label>
                                <div class="col-md-6">
